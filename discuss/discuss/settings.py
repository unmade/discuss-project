...
SECRET_KEY = 'w=*i0^kwn!2!j+u&j%^unap%ovi_0*r0ieuh-fclw*-x!-j^cq'
...
MIDDLEWARE = [
    ...
    'debug_toolbar.middleware.DebugToolbarMiddleware',  # TODO: dev
]
...
INTERNAL_IPS = ['127.0.0.1']  # TODO: dev
